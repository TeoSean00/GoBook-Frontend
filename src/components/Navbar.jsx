...
export default function Navbar({ profileImage }) {
  ...
  return (
    <>
      <nav className="container mx-auto rounded-lg border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-800 ">
        <div className="container mx-auto flex flex-wrap items-center  justify-between gap-x-5  md:flex-nowrap">
          <div className=" flex w-full justify-between gap-x-2">
            <div className="flex gap-x-3">
              <span className="hidden self-center whitespace-nowrap text-xl font-semibold text-blue-700 dark:text-gray-50 sm:block">
                GoBook
              </span>
              <a
                href="#"
