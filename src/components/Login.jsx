...
const Login = ({ handleLogin }) => {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 py-12 px-4 dark:bg-gray-900 sm:px-6 lg:px-8">
      <div className="max-w-sm rounded-xl border border-gray-300 bg-gray-200 shadow dark:border-gray-700 dark:bg-gray-800 md:flex md:max-w-2xl">
        <div className="rounded-t-xl bg-gray-200 p-5 dark:bg-gray-800 md:rounded-l-xl md:rounded-r-none">
