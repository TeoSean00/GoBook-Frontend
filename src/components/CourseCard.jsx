    ...
    <div>
      {course ? (
        <Link
          ...
          state={user}
          className="block max-w-sm cursor-alias rounded-lg border border-gray-200 bg-white p-3 shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-slate-800 dark:shadow-gray-700 dark:hover:bg-slate-900 sm:h-full md:p-6"
        >
          <h5
